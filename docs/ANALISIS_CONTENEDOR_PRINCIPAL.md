...
Qué FUNCIONA
 ...
 La interfaz web se abre en localhost:8096
...
Mostró la interfaz principal después del login
 ...
 Puedo agregar contenido manualmente
...
bash  mkdir -p ./config/jellyfin/data/playlists
...
Radarr — sin él, nadie avisa a Jellyfin cuando hay contenido nuevo y no hay descarga automatizada
qBittorrent — Radarr necesita un cliente torrent para ejecutar las descargas
Prowlarr — sin fuentes de búsqueda, Radarr no sabe dónde encontrar los torrents
Traefik — no es estrictamente necesario, pero simplifica el acceso a todos los servicios con dominios locales en vez de puertos
...
Un contenedor aislado expone sus limitaciones rápidamente — Jellyfin necesita que otros servicios "alimenten" su carpeta /media
Los volúmenes Docker persisten datos entre reinicios, pero la estructura interna de carpetas debe existir previamente
En arquitecturas de microservicios cada servicio hace una sola cosa bien — Jellyfin sirve, Radarr gestiona, qBittorrent descarga
